...
class FriendTableViewCell: UITableViewCell {
    ...
    func setAttributedUserName(withUserFriend userFriend: UserFriend) -> NSMutableAttributedString {
        ...
        titleStr.append(NSAttributedString(string: userFriend.displayName(), attributes: [NSAttributedString.Key.foregroundColor: UIColor.init(hex: "3F3F3F"), NSAttributedString.Key.font: UIFont(name: "HelveticaNeue", size: 15)!]))
        titleStr.append(NSAttributedString(string: """
    
    
    """, attributes: nil))
        titleStr.append(NSAttributedString(string: userFriend.email ?? "", attributes: [NSAttributedString.Key.foregroundColor: UIColor.init(hex: "7F7F7F"), NSAttributedString.Key.font: UIFont(name: "HelveticaNeue", size: 11)!]))
        return titleStr
    }
}
